...
- **Inviti collaboratori**: funzionano solo se la persona ha già un account Coach Diary. Un vero flusso di invito via email (con link di registrazione) richiede un servizio email (es. Resend) non ancora integrato.
